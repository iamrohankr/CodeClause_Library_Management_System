...
public class issueBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, 200, -1));
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 200, -1));
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 200, 200, -1));
        getContentPane().add(jDateChooser2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 230, 200, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          try
        {
            ...
            {   ResultSet rs1=st.executeQuery("select * from book where bookID='"+bookID+"'");
                if(rs1.next())
                {
                    String query = "insert into issue values('"+bookID+"','"+StudentID+"','"+issueDate+"','"+dueDate+"','"+returnBook+"') ";
